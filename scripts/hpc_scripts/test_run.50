...
# Sending test run to the HPC
echo -e "Sending test run command."
python3 -m pvt_model --initial-month 9 \
    --location system_data/london_ilaria/ \
    --pvt-data-file system_data/pvt_panels/ilarias_panel.yaml \
    --output $OUTPUT_DIR/ilaria_single_glazed_1_0_litres_per_hour_31_x_50 \
    ...
    --layers g pv a p f --portion-covered 0 --skip-analysis --mass-flow-rate 1 ;
