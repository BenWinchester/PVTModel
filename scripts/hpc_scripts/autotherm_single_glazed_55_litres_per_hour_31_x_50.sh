...
python3.7 -m pvt_model --initial-month 9 --location system_data/london_ilaria/ \
    ...
    --output output_files/hpc_run_outputs/autotherm_single_glazed_pv_layer_present_55_litres_per_hour_31_x_50 \
    ...
    --layers g pv a p f --portion-covered 1 --skip-analysis --mass-flow-rate 55
