...
OUTPUT_FILE="output_files/large_parameter_low_iron_6_pipe_autotherm/output_file_$PBS_ARRAY_INDEX"
...
python3.7 -u -m src.pvt_model --skip-analysis \
    ...
    --portion-covered 1 \
    --pvt-data-file system_data/pvt_panels/autotherm_0_95_glass_transmissivity_6_pipes.yaml \
